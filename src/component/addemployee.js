...
function AddEmployee() {
  ...
  return (
    ...
    <button 
        onClick={handleShow}
        className=
        "block mx-auto px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2" onClick={handleShow}>Add Employee</button>
      ...
      >
        ...
        <Modal.Body>
        <form id="edit" className="w-full max-w-sm">
        ...
        <Modal.Footer>
          ...
          <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' form="edit">Add</button>
        </Modal.Footer>
      </Modal>
    </>
  );
